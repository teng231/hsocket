...
type Conversations struct {
	...
	NextPage      int64           `protobuf:"varint,4,opt,name=next_page,json=nextPage,proto3" json:"next_page,omitempty"`
}
...
func (m *Conversations) GetNextPage() int64 {
	if m != nil {
		return m.NextPage
	}
	return 0
...
func (m *ConversationRequest) GetLimit() int64 {
	if m != nil {
		return m.Limit
	}
	return 0
...
func (m *ConversationRequest) GetPage() int64 {
	if m != nil {
		return m.Page
	}
	return 0
...
func (m *ConversationRequest) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
var fileDescriptor_6398613e36d6c2ce = []byte{
	...
	,
}
